...
<div id="mainContainer">
	...
	if (isset($_GET['search'])) {
		...
		$searchTerm = '%' . $q . '%';
		$results = getAll("SELECT products.product_id, products.name, products.description, price, media.path as image_url FROM products INNER JOIN media ON products.media_id = media.media_id WHERE products.name LIKE ? OR products.description LIKE ?", [$searchTerm, $searchTerm]);
