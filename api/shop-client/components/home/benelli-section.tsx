    ...
    return (
        <>
            {/* <section
                ...
                className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-32 lg:px-8 mb-24 sm:mb-32"
            >
                <div className="relative overflow-hidden rounded-lg group">
                    <div className="absolute inset-0 group">
                        <Image
                            ...
                            width={500}
                            height={500}
                            className="h-full w-full object-cover object-center duration-500 group-hover:scale-110 transition hover:scale-110 z-30"
                        />
                    </div>
