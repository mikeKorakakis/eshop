...
export default function UserNavClient({ dictionary, customer, order }: Props) {
      ...
      {SHOP_ENABLED && (
        <>
          ...
          <div className="flex items-center lg:ml-8">
            ...
            {/* Cart */}
            {process.env.NEXT_PUBLIC_COMMERCE_CART_ENABLED && (
              <div
                className={clsx(
                  'ml-4 flow-root'
            ...
            {process.env.NEXT_PUBLIC_COMMERCE_CUSTOMERAUTH_ENABLED && (
              <div className="ml-4 flow-root ">
