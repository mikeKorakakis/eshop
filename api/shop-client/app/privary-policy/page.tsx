      ...
      {/* <div className="absolute mt-2 ">
        <BreadCrumps
          navigation={[
            ...
            { name: t('common:privacy_policy'), href: '#' },
          ]}
        />
      </div> */}
      <Privacy dictionary={dictionary} />
    </>
  );
}

const Privacy = ({ dictionary }: { dictionary: Dictionary }) => {
  const common_dictionary = dictionary.common;
  const privary_dictionary = dictionary.privacy_policy;
  return (
    <div className="relative overflow-hidden py-16 sm:py-32">
      ...
      <div className="relative px-6 lg:px-8">
        ...
        <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
          <div dangerouslySetInnerHTML={{ __html: privary_dictionary.privacy_policy_p1 }}></div>
        </div>
      </div>
    </div>
  );
