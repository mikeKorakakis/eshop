...
INSERT INTO `products` 
    (`product_id`, `name`, `description`, `price`, `added_date`, `country_of_origin`, `category_id`, `owner_id`)
VALUES
    -- Category 1 (ID=1, "Αξεσουάρ")
    ...
    (3, 'Εργονομικό Πληκτρολόγιο', 'Πληκτρολόγιο με εργονομικό σχεδιασμό', '45.50', '2023-01-18', 'Κίνα', 1, 1),
    (4, 'Ακουστικά Gaming', 'Over-ear ακουστικά με καθαρό ήχο', '65.00', '2023-01-22', 'Ιαπωνία', 1, 1),

    -- Category 2 (ID=2, "Φορητοί Υπολογιστές")
    (5, 'Φορητός Gaming Υπολογιστής', 'Υψηλής απόδοσης φορητός υπολογιστής για gaming', '1500.00', '2023-01-14', 'Ιαπωνία', 2, 1),
    (6, 'Ultrabook Pro', 'Ελαφρύς φορητός υπολογιστής με μεγάλη αυτονομία μπαταρίας', '1299.00', '2023-01-16', 'ΗΠΑ', 2, 1),
    (7, 'Επαγγελματικός Φορητός Υπολογιστής', 'Υπολογιστής σχεδιασμένος για επαγγελματικές εφαρμογές', '999.99', '2023-02-10', 'Γερμανία', 2, 1),
    (8, 'Φορητό Chromebook', 'Εύχρηστο Chromebook ιδανικό για απλές εργασίες', '350.00', '2023-02-15', 'Καναδάς', 2, 1),

    -- Category 3 (ID=3, "Επιτραπέζιοι Υπολογιστές")
    (9, 'Προσωπικός Υπολογιστής', 'Επιτραπέζιος υπολογιστής υψηλών επιδόσεων', '999.00', '2023-01-16', 'Νότια Κορέα', 3, 1),
    (10, 'Γραφιστικός Σταθμός Εργασίας', 'Δυνατός σταθμός εργασίας για γραφικά και βίντεο', '2000.00', '2023-02-20', 'Σουηδία', 3, 1),
    (11, 'Mini PC', 'Μικρός και αθόρυβος επιτραπέζιος υπολογιστής', '450.00', '2023-03-01', 'Κίνα', 3, 1),
    (12, 'All-in-One Υπολογιστής', 'Οθόνη και υπολογιστής σε μία ενιαία συσκευή', '899.99', '2023-03-05', 'ΗΠΑ', 3, 1);
