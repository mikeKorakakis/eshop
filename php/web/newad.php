...
if (isset($_SESSION['user'])) {
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (empty($formErrors)) {
			...
			if (move_uploaded_file($avatarTmp, "admin/uploads/items/" . $avatar)) {
				...
				$formErrors[] = 'Failed to upload the file. Please check the directory permissions.';
			}
						...
						<div class="col-md-8">
							<form class="form-horizontal main-form" action="<?php echo $_SERVER['PHP_SELF'] ?>"
								...
								<div class="form-group form-group-lg">
									...
									<div class="col-sm-10 col-md-9">
										<input type="text" name="contact" class="form-control"
											placeholder="Phone Number of the Item owner" required />
									</div>
								</div>
								<!-- End Description Field -->
								<!-- Start Price Field -->
								...
								<div class="form-group form-group-lg">
									...
									<div class="col-sm-10 col-md-9">
										<input id='imginp' type="file" name="itempic" class="form-control"
